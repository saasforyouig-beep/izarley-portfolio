...
/**
 * Threads (ReactBits) — linhas onduladas em WebGL com ruído Perlin e
 * interação de mouse. Adaptado para TypeScript; o mouse é ouvido na
 * janela para o efeito continuar reagindo sobre o texto do hero.
 */
...
export default function Threads({
  ...
  useEffect(() => {
    ...
    // shader pesado (Perlin por pixel × 40 linhas): limita a resolução
    // interna para manter telas grandes/high-DPI fluidas
    ...
    // na janela: o efeito segue o cursor mesmo sobre o texto por cima
  ...
  return (
    <div
      ref={containerRef}
      className={`threads-container${className ? ` ${className}` : ''}`}
      aria-hidden="true"
    />
  )
}
